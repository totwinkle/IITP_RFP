...
async function parseImage(buffer, options) {
  try {
    const { parseImageDocument } = await import("./image-ocr-XHBZONFZ.js");
...
async function parsePdf(buffer, options) {
  ...
  try {
    const mod = await import("./parser-Z36MZUHS.js");
